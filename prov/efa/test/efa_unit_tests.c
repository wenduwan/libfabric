...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_efa_cuda_dmabuf_support_lazy_init_success, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_cuda_dmabuf_support_lazy_init_get_fd_fail_fallback, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_cuda_dmabuf_support_lazy_init_mr_fail_fallback, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_cuda_dmabuf_support_mr_fail_unexpectedly, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown), 
		...
		cmocka_unit_test_setup_teardown(test_efa_neuron_dmabuf_support_lazy_init_success, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_neuron_dmabuf_support_lazy_init_get_fd_fail_fallback, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_neuron_dmabuf_support_lazy_init_mr_fail_fallback, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_neuron_dmabuf_support_always_ibv_reg_mr, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		cmocka_unit_test_setup_teardown(test_efa_neuron_dmabuf_support_mr_fail_unexpectedly, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
		...
		cmocka_unit_test_setup_teardown(test_efa_synapseai_dmabuf_support_mr_fail_unexpectedly, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),
	};

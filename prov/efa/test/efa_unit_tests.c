...
int main(void)
{
	...
	const struct CMUnitTest efa_unit_tests[] = {
		...
		cmocka_unit_test_setup_teardown(test_ibv_cq_ex_read_bad_send_status_unresponsive_receiver_missing_host_ids, efa_unit_test_mocks_setup, efa_unit_test_mocks_teardown),

 ...
 */
void test_efa_cuda_dmabuf_support_lazy_init_success();
void test_efa_neuron_dmabuf_support_lazy_init_success();
/**
 * If dmabuf fd cannot be retrieved, verify dmabuf is not supported lazily
 * for the HMEM iface
 */
void test_efa_cuda_dmabuf_support_lazy_init_get_fd_fail_fallback();
void test_efa_neuron_dmabuf_support_lazy_init_get_fd_fail_fallback();
/**
 * If ibv_reg_dmabuf_mr fails, verify dmabuf is not supported lazily
 * for the HMEM iface
 */
void test_efa_cuda_dmabuf_support_lazy_init_mr_fail_fallback();
void test_efa_neuron_dmabuf_support_lazy_init_mr_fail_fallback();
/**
 * If dmabuf is not supported, verify we always use ibv_reg_mr
 */
void test_efa_cuda_dmabuf_support_always_ibv_reg_mr();
void test_efa_neuron_dmabuf_support_always_ibv_reg_mr();
/**
 * If dmabuf is supported we should always use ibv_reg_dmabuf_mr,
 * even if it fails unexpctedly
 */
void test_efa_cuda_dmabuf_support_mr_fail_unexpectedly();
void test_efa_neuron_dmabuf_support_mr_fail_unexpectedly();
void test_efa_synapseai_dmabuf_support_mr_fail_unexpectedly();
/**
